        ...
        <ul>
            ...
            <li>In order to be eligible for a forfeit win at the default time due to the other team not having 5 players in the lobby, the following additional conditions steps need to be taken:
                <ul>
                    ...
                    <li>Five players from the team's official roster must be seated on either the dire or radiant side. Please make your team name visible to make it easier for the admin to score the match. (Stand-ins cannot be used to gain a forfeit win. Free agents can, since they become a part of the team's official roster when assigned.)</li>
